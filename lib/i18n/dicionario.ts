...
export const DICIONARIO: Traducoes = {
  ...
  "Novo fluxo de disparo": { es: "Nuevo flujo de disparo" },
  "Criar imagem + texto para os atendentes dispararem no chat.": {
    es: "Crear imagen + texto para que el equipo dispare en el chat.",
  },
  Galeria: { es: "Galería" },
  "As imagens do time: do chat, dos fluxos e as suas pastas.": {
    es: "Las imágenes del equipo: del chat, de los flujos y tus carpetas.",
  },
  "As imagens do time — do chat, dos fluxos e as suas. O que o cliente mandou não entra aqui.": {
    es: "Las imágenes del equipo — del chat, de los flujos y las tuyas. Lo que mandó el cliente no entra aquí.",
  },
  "Galeria — escolher imagem": { es: "Galería — elegir imagen" },
  "Subir imagem": { es: "Subir imagen" },
  "Nova pasta…": { es: "Nueva carpeta…" },
  "Criar pasta": { es: "Crear carpeta" },
  "Sem pasta": { es: "Sin carpeta" },
  "Pesquisar pelo nome…": { es: "Buscar por nombre…" },
  "Nada por aqui ainda.": { es: "Nada por aquí todavía." },
  "Nada por aqui — suba imagens na página Galeria.": {
    es: "Nada por aquí — sube imágenes en la página Galería.",
  },
  Pasta: { es: "Carpeta" },
  Apagar: { es: "Eliminar" },
  "Apagar da Galeria?": { es: "¿Eliminar de la Galería?" },
  "Esta imagem sai da Galeria e é apagada do armazenamento:": {
    es: "Esta imagen sale de la Galería y se elimina del almacenamiento:",
  },
  "Ela aparece em mensagens e fluxos — esses lugares vão quebrar.": {
    es: "Aparece en mensajes y flujos — esos lugares se van a romper.",
  },
  fluxos: { es: "flujos" },
  "Erro ao subir.": { es: "Error al subir." },
  "Imagem na Galeria.": { es: "Imagen en la Galería." },
  "Não deu para criar a pasta.": { es: "No se pudo crear la carpeta." },
  "Não deu para renomear.": { es: "No se pudo renombrar." },
  "Não deu para mover.": { es: "No se pudo mover." },
  "Apagada da Galeria e do armazenamento.": { es: "Eliminada de la Galería y del almacenamiento." },
  "Não deu para apagar.": { es: "No se pudo eliminar." },
  "Dê um nome ao fluxo para ativá-lo.": { es: "Ponle un nombre al flujo para activarlo." },
  "Cadastre ao menos uma mensagem (imagem ou texto).": {
    es: "Registra al menos un mensaje (imagen o texto).",
  },
  "A imagem da mensagem": { es: "La imagen del mensaje" },
  "não pode ser enviada: use URL https ou suba o arquivo pela Galeria.": {
    es: "no se puede enviar: usa una URL https o sube el archivo por la Galería.",
  },
  "Fluxo de disparo criado com sucesso.": { es: "Flujo de disparo creado con éxito." },
  "Fluxo de disparo salvo.": { es: "Flujo de disparo guardado." },
  "Erro ao salvar. Tente novamente.": { es: "Error al guardar. Intenta de nuevo." },
  "Falha no envio da imagem.": { es: "Fallo en el envío de la imagen." },
  "Voltar para Fluxos": { es: "Volver a Flujos" },
  "Criar fluxo de disparo": { es: "Crear flujo de disparo" },
  "Nome do fluxo": { es: "Nombre del flujo" },
  "Ex: Scooter Elétrica 1000W - Oferta": { es: "Ej.: Scooter Eléctrica 1000W - Oferta" },
  Digitando: { es: "Escribiendo" },
  segundos: { es: "segundos" },
  "O cliente vê “digitando…” neste intervalo entre as mensagens.": {
    es: "El cliente ve “escribiendo…” en este intervalo entre los mensajes.",
  },
  "Subir na ordem de envio": { es: "Subir en el orden de envío" },
  "Descer na ordem de envio": { es: "Bajar en el orden de envío" },
  "Excluir mensagem": { es: "Eliminar mensaje" },
  "Imagem (opcional)": { es: "Imagen (opcional)" },
  Upload: { es: "Subir" },
  URL: { es: "URL" },
  "https://... URL pública da imagem": { es: "https://... URL pública de la imagen" },
  "Prévia da imagem": { es: "Vista previa de la imagen" },
  "PNG, JPG, WEBP até 15MB": { es: "PNG, JPG, WEBP hasta 15MB" },
  "Legenda (vai junto da imagem)": { es: "Leyenda (va con la imagen)" },
  Texto: { es: "Texto" },
  "Ex: 12x de R$ 825,00 no cartão…": { es: "Ej.: 12x de R$ 825,00 en la tarjeta…" },
  "Adicionar mensagem": { es: "Añadir mensaje" },
  "Arrastar para reordenar": { es: "Arrastrar para reordenar" },
  "· Imagem + legenda": { es: "· Imagen + leyenda" },
  "· Imagem": { es: "· Imagen" },
  "· Texto": { es: "· Texto" },
  "Clique para configurar…": { es: "Clic para configurar…" },
  "Digitando por": { es: "Escribiendo por" },
  "Selecione um arquivo de imagem válido (PNG, JPG, WEBP).": {
    es: "Selecciona un archivo de imagen válido (PNG, JPG, WEBP).",
  },
  "Erro ao fazer upload da imagem.": { es: "Error al subir la imagen." },
  "Imagem carregada com sucesso!": { es: "¡Imagen cargada con éxito!" },
  // Cobertura ES de telas de fluxos/galeria/chat (dívida pré-existente do
  ...
  "Você pode colar uma imagem (Ctrl+V), escolher um arquivo local do PC/Celular ou colar um link.": {
    es: "Puedes pegar una imagen (Ctrl+V), elegir un archivo local del PC/móvil o pegar un enlace.",
  },
  "Texto com especificações": { es: "Texto con especificaciones" },
  "Sai exatamente assim, sem IA.": { es: "Sale exactamente así, sin IA." },
  "Renomear fluxo": { es: "Renombrar flujo" },
  "Renomear Fluxo": { es: "Renombrar flujo" },
  "Criar uma cópia deste fluxo": { es: "Crear una copia de este flujo" },
  "Excluir fluxo": { es: "Eliminar flujo" },
  "Novo fluxo de IA": { es: "Nuevo flujo de IA" },
  "fluxos selecionados": { es: "flujos seleccionados" },
  "Todos os fluxos selecionados serão apagados permanentemente. Esta ação não pode ser desfeita.": {
    es: "Todos los flujos seleccionados se eliminarán permanentemente. Esta acción no se puede deshacer.",
  },
  "Erro ao excluir alguns dos fluxos selecionados.": {
    es: "Error al eliminar algunos de los flujos seleccionados.",
  },
  "Excluindo...": { es: "Eliminando..." },
  "Nenhum fluxo de disparo cadastrado": { es: "Ningún flujo de disparo registrado" },
  "Nenhum fluxo automático de IA ainda": { es: "Ningún flujo automático de IA todavía" },
  "Crie fluxos de imagem + especificações para os atendentes dispararem facilmente no chat.": {
    es: "Crea flujos de imagen + especificaciones para que el equipo dispare fácilmente en el chat.",
  },
  "Follow-ups automáticos reengajam contatos após silêncio ou mudança de etapa.": {
    es: "Los seguimientos automáticos reenganchan contactos tras silencio o cambio de etapa.",
  },
  "Pesquisar fluxos de disparo por nome...": { es: "Buscar flujos de disparo por nombre..." },
  "Pesquisar fluxos de IA...": { es: "Buscar flujos de IA..." },
  "Limpar pesquisa": { es: "Limpiar búsqueda" },
  "fluxo(s) selecionado(s)": { es: "flujo(s) seleccionado(s)" },
  "Excluir selecionados": { es: "Eliminar seleccionados" },
  "Selecionar todos": { es: "Seleccionar todos" },
  Estado: { es: "Estado" },
  "Caixa de Entrada": { es: "Bandeja de entrada" },
  "Habilita a exibição e disparo manual deste fluxo no chat do operador": {
    es: "Habilita la visualización y el disparo manual de este flujo en el chat del operador",
  },
  Atualizado: { es: "Actualizado" },
  "Sem imagem cadastrada": { es: "Sin imagen registrada" },
  "Abrir editor visual de nós": { es: "Abrir editor visual de nodos" },
  "Fluxo duplicado com sucesso.": { es: "Flujo duplicado con éxito." },
  "Duplicar fluxo": { es: "Duplicar flujo" },
  "Edição rápida": { es: "Edición rápida" },
  "Fluxo de disparo": { es: "Flujo de disparo" },
  "Fluxos de Disparo": { es: "Flujos de disparo" },
  "Pesquisar fluxo de disparo...": { es: "Buscar flujo de disparo..." },
  "Carregando fluxos…": { es: "Cargando flujos…" },
  "Nenhum fluxo ativo habilitado para a Caixa de Entrada.": {
    es: "Ningún flujo activo habilitado para la bandeja de entrada.",
  },
  "Nenhum fluxo encontrado com esse termo.": {
    es: "Ningún flujo encontrado con ese término.",
  },
  "Pronto para envio": { es: "Listo para enviar" },
  "Menu de atalhos e templates": { es: "Menú de atajos y plantillas" },
  "Enviar imagem + especificações ao cliente": {
    es: "Enviar imagen + especificaciones al cliente",
  },
  "Nenhum resultado encontrado.": { es: "Ningún resultado encontrado." },
  "Nome atualizado.": { es: "Nombre actualizado." },
  "Fluxo atualizado.": { es: "Flujo actualizado." },
  ...
  "Criar e publicar": { es: "Crear y publicar" },
  "Rascunho criado.": { es: "Borrador creado." },
  "Fluxo de disparo publicado.": { es: "Flujo de disparo publicado." },
  "Erro ao publicar. Tente novamente.": { es: "Error al publicar. Intenta de nuevo." },
  "Erro ao desativar.": { es: "Error al desactivar." },
  "Dê um nome ao fluxo para publicá-lo.": { es: "Ponle un nombre al flujo para publicarlo." },
  "Dê um nome ao fluxo para criar o rascunho.": {
    es: "Ponle un nombre al flujo para crear el borrador.",
  },
  "Imagem salva — a prévia carrega em instantes.": {
    es: "Imagen guardada — la vista previa carga en instantes.",
  },
